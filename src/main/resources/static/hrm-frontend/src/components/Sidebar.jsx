...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    sync();
    // Use addEventListener when available, fallback to older API
  ...
  const menuItems = [
    ...
    { path: '/dashboard/departments', icon: <Building2 size={20} />, label: 'Departments' },
  ...
  return (
    ...
    >
      ...
      <nav className="sidebar-nav" style={{ paddingBottom: '5rem' }}>
        <ul>
