...
public class Department {
    ...
    public Department(Long id, String name, String description, String headOfDepartment,
    ...
    public static class Builder {
        ...
        public Department build() {
            return new Department(id, name, description, headOfDepartment, createdDate, employees);
        }
    }
}
